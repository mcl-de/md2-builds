...
var DateUtil = (function () {
     ...
     */
    DateUtil.prototype.getWeekOfYear = function (date) {
...
], Md2Calendar.prototype, "displayWeek", void 0);
__decorate$57([
    _angular_core.Input(),
...
], exports.Md2Datepicker.prototype, "displayWeek", void 0);
__decorate$56([
    _angular_core.Input(),
...
], exports.Md2CalendarBody.prototype, "displayWeek", void 0);
__decorate$61([
    _angular_core.Output(),
    __metadata$36("design:type", Object)
...
], exports.Md2MonthView.prototype, "displayWeek", void 0);
__decorate$60([
    _angular_core.Input(),
...
exports.Md2MonthView = __decorate$60([
    _angular_core.Component({selector: 'md2-month-view',
        template: "<table class=\"md2-calendar-table\"><thead class=\"md2-calendar-table-header\"><tr><th *ngIf=\"displayWeek\">#</th><th *ngFor=\"let day of _weekdays\" [attr.aria-label]=\"day.long\">{{day.narrow}}</th></tr></thead><tbody [@slideCalendar]=\"_calendarState\" (@slideCalendar.done)=\"_calendarStateDone()\" md2-calendar-body role=\"grid\" [rows]=\"_weeks\" [todayValue]=\"_todayDate\" [selectedValue]=\"_selectedDate\" [displayWeek]=\"displayWeek\" [activeCell]=\"_util.getDate(activeDate) - 1\" (selectedValueChange)=\"_dateSelected($event)\"></tbody></table>",
        animations: [slideCalendar],
        encapsulation: _angular_core.ViewEncapsulation.None,
        changeDetection: _angular_core.ChangeDetectionStrategy.OnPush,
    }),
